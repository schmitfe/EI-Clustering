...
def run_active_set_em(
    ...
    detection = detect_population_states(
        ...
        pelt_jump=int(method_cfg.get("pelt_jump", 5)),
        pelt_refine=bool(method_cfg.get("pelt_refine", False)),
        changepoint_backend=str(method_cfg.get("changepoint_backend", method_cfg.get("pelt_backend", "skchange"))),
        changepoint_method=str(method_cfg.get("changepoint_method", "pelt")),
        changepoint_bandwidth=int(method_cfg.get("changepoint_bandwidth", 20)),
        changepoint_max_interval_length=int(method_cfg.get("changepoint_max_interval_length", 200)),
        changepoint_parallel_backend=str(method_cfg.get("changepoint_parallel_backend", "None")),
        changepoint_parallel_jobs=int(method_cfg.get("changepoint_parallel_jobs", 1)),
